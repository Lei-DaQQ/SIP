  ...
  <div>
    ...
    <div class="mapMain">
      <el-table :data="maps" border @selection-change="handleSelectionChange" size="small" stripe style="width: 50%">
        ...
        <el-table-column prop="createDate" width="250" label="缩略">
    ...
    <el-dialog title="增加地图" :visible.sync="dialogVisible_add" width="40%">
      <el-form :model="AddMap" :label-width="formLabelWidth">
        ...
        <el-form-item label="地图 url">
          <el-input class="addMapInput" size="small" v-model="AddMap.url" autocomplete="off" prefix-icon="el-icon-link" placeholder="请输入地图url"></el-input>
        </el-form-item>
      </el-form>
  ...
  methods: {
    deleteMany() {
      this.$confirm('此操作将永久删除 【 ' + this.multipleSelection.length + '】条记录, 是否继续?', '提示', {
        ...
        this.deleteRequest("/map/manage/" + ids).then(resp => {
          if (resp) {
            this.initMaps();
          }
        })
